...
public class ChatAcceptedPatientFragment extends Fragment {

    View rootView;
    ConnectionDetector connectionDetector;
    RecyclerView recyclerView;
    ViewPatientChatAdapter viewPatientChatAdapter;
    SwipeRefreshLayout refreshLayout;
    List<ChatAcceptedPatientReceiveParams.DataBean> dataBeanArrayList = new ArrayList<>();
    Context context;
    private ShimmerFrameLayout mShimmerLayout;
    String strPatientID;
    private static final String TAG = "ChatAcceptedPatientFrag";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView=inflater.inflate(R.layout.fragment_chat_accepted_patient,container,false);

        recyclerView = rootView.findViewById(R.id.acceptedPatientListRecyclerView);
        mShimmerLayout = rootView.findViewById(R.id.acceptedPatientShimmer);
        refreshLayout = rootView.findViewById(R.id.acceptedPatientSwipeRefreshLayout);
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if(connectionDetector.isNetworkAvailable() || connectionDetector.isDataAvailable()) {
                            viewAcceptedPatientChat(strPatientID);
                        } else {
    ...
    private void viewAcceptedPatientChat(String patientID){
        ...
        call.enqueue(new Callback<ChatAcceptedPatientReceiveParams>() {
            ...
            public void onResponse(Call<ChatAcceptedPatientReceiveParams> call, Response<ChatAcceptedPatientReceiveParams> response) {
                if (response.body() != null) {
                    ...
                    viewPatientChatAdapter = new ViewPatientChatAdapter(context, dataBeanArrayList);
                    recyclerView.setAdapter(viewPatientChatAdapter);
                    pDialog.dismiss();
